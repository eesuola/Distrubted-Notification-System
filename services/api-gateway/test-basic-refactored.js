import { createIsolatedTestServer, generateTestJWT, generateTestNotification, getMockData, resetMockData } from './test-helper-isolated.js';
...
async function runTests() {
  console.log('🚀 Starting Refactored API Gateway Tests');
  console.log('=====================================');
  ...
  try {
    ...
    const { server: serverInstance, cleanup } = await createMockServer();
    ...
    if (testResults.failed === 0) {
      ...
      console.log('\nThe refactored test using the new test helper is working correctly.');
    } else {
